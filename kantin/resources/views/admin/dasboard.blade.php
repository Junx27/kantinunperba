    ...
    <section class="container mx-auto py-5">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-purple-300 shadow-md p-8 rounded-md text-center">
                ...
                <a href="http://127.0.0.1:8000/admin/daftarmenu">
            ...
            <div class="bg-blue-300 shadow-md p-8 rounded-md text-center">
                <p class="text-gray-600"><span class="material-symbols-outlined">shopping_cart</span>
                    <a href="http://127.0.0.1:8000/admin/historypenjualan">
                        <h3 class="text-xl font-semibold mb-4">History Penjualan
                    </a></button>
            </div>
            <!-- Fitur 3 -->
            <div class="bg-green-300 shadow-md p-8 rounded-md text-center">
                ...
                <a href="http://127.0.0.1:8000/admin/historypembelian">
                    <h3 class="text-xl font-semibold mb-4">Data Pelanggan
                </a></button>
            </div>
            <!-- Fitur 4 -->
            <div class="bg-yellow-300 shadow-md p-8 rounded-md text-center">
                ...
                <a href="http://127.0.0.1:8000/admin/pesananmasuk">
                    <h3 class="text-xl font-semibold mb-4">Pesanan Masuk
                </a></button>
    </section>
    @endsection
