...
<div class="text-xs mt-2 w-full bg-white p-5 rounded-lg">
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="relative bg-white rounded-lg shadow-md">
            <img src="{{$menu["gambar"]}}" alt="Product 2" class="w-full h-96 object-cover rounded-lg hover:scale-[101%] transition-transform duration-500">
            ...
            <div class="absolute top-64 left-2 z-10 p-4">
                ...
                <button class="transition-all duration-500 w-16 mt-2 bg-orange-500 hover:bg-black text-white p-1 rounded">Hapus</button>
            </div>
        </div>
        @endforeach
    </div>
