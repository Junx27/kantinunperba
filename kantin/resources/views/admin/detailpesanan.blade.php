        ...
        <div class="flex flex-row">
            <div class="text-xs w-full mt-2 rounded-lg">
                ...
                <div class="relative mt-2 bg-white rounded-lg w-full h-[470px] p-5 overflow-auto">
                    <img src="{{ $pesanan->foto}}" alt="" class="mx-auto w-32 h-32 rounded-full object-cover">
                    <h1 class="sticky -top-5 bg-white border-b font-bold text-center mt-5 py-3 px-4">{{ $pesanan->nama_pembeli }}</h1>
