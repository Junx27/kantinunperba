...
<div class="fixed top-2 text-xs w-[300px] h-[760px] bg-white p-5 rounded-lg mr-3 overflow-auto">
    ...
    <div class="mt-5">
        ...
        <a href="/user/pembayaran/{{ $pembayarans->id }}" class="{{ request()->is('user/pembayaran/' .$pembayarans->id) ? 'transition-all duration-500 my-2 p-4 bg-lime-400 rounded-lg cursor-pointer flex flex-col' : 'transition-all duration-500 my-2 p-4 hover:bg-lime-400 hover:rounded-lg cursor-pointer flex flex-col' }}">
    ...
    <div class="z-10 sticky top-0 mt-2 text-xs w-full h-[110px] bg-white p-5 rounded-lg">
            ...
            <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <tbody>
                    <tr class="bg-white">
                        ...
                        <td class="py-2 px-4 border">{{ $pembayaran->metode_pembayaran }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="text-xs w-full rounded-lg">
            ...
            <h1 class="text-start my-5 font-bold ml-2 capitalize">Detail pesanan:</h1>
                ...
                <a href="/user/pembayaran/{{$pembayaran->id}}/edit" class="mt-10 flex justify-end">
