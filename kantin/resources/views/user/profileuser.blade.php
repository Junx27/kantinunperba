...
@section("container")
<div class="text-xs">
    <div class="relative bg-white h-screen rounded-lg pb-[87px]">
        <div class="flex">
        ...
        <div class="relative w-96">
            <span class="z-20 w-20 h-20 bg-transparent absolute rounded-br-full top-[48px] left-[64.9px] shadow-myShadow1"></span>
            <span class="z-20 w-20 h-20 bg-transparent absolute rounded-bl-full top-[48px] -right-[63px] shadow-myShadow2"></span>
