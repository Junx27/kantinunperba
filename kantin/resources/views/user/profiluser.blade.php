...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center ml-1/5 p-8">
        ...
        <div class="flex">
            ...
            <div>
            <div class="mb-4">
                    <label for="nama_user" class="block mb-1">Nama:</label>
                    <p id="nama_user">Dinda ayu</p>
                </div>
                <div class="mb-4">
                    <label for="jenis_kelamin" class="block mb-1">Jenis Kelamin:</label>
                    <p id="jenis_kelamin">Perempuan</p>
                </div>
                <div class="mb-4">
                    <label for="telepon" class="block mb-1">Telepon:</label>
                    <p id="telepon">08123456789</p>
                </div>
                <div class="mb-4">
                    <label for="email" class="block mb-1">Email:</label>
                    <p id="email">dinda@gmail.com</p>
                </div>
            </div>
        </div>
    </div>
